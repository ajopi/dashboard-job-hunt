          ...
          <div>
            ...
            <div className="text-gray-500 mt-3">
              <p>
                ...
                Dolorum, deleniti! Porro ullam error non consectetur, tempora
                consequuntur inventore asperiores dicta nam commodi sed nobis?
                Tempora accusantium sunt dolorum possimus nam.
              </p>
            </div>
          </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-4 gap-5 mt-9">
          {[0, 1, 2].map((item: number, i: number) => {
            return (
              <div key={i}>
                <CircleCheck className="w-10 h-10 text-primary mb-6" />
